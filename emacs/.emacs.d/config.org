...
#+BEGIN_SRC emacs-lisp
  ;; (ignore-errors
    (use-package exwm
      :ensure nil 
      :demand t
      :bind (("<XF86AudioRaiseVolume>" . audio/raise-volume)
...
It sucks that I have to write these...
#+BEGIN_SRC emacs-lisp
  (defun audio/mute ()
    (interactive)
    (start-process-shell-command "audio/mute"
				 nil
				 "amixer set 'Master' 0%"))
  (defun audio/raise-volume ()
    (interactive)
    (start-process-shell-command "audio/raise-volume"
				 nil
				 "amixer set 'Master' 5%+"))
  (defun audio/lower-volume ()
    (interactive)
    (start-process-shell-command "audio/lower-volume"
				 nil
				 "amixer set 'Master' 5%-"))
  (defun screenshot ()
    (interactive)
    (start-process-shell-command "screenshot"
				 nil
