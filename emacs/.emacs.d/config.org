...
#+BEGIN_SRC emacs-lisp
  (defun jmw-org-cancel ()
    ...
    (org-todo "CANCEL")
    (org-clock-goto))
  (define-key 'jmw-org-prefix "c" 'jmw-org-done)
#+END_SRC
*** other
   :PROPERTIES:
...
#+BEGIN_SRC emacs-lisp
  (defun jmw-org-comment ()
    ...
    (insert " JMW:* "))
  (define-key 'jmw-org-prefix "a c" 'jmw-org-comment)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (defun jmw-org-highlight-region (from to)
	...
	(insert "*"))
      (deactivate-mark)
      (fill-paragraph)))
  (define-key 'jmw-org-prefix "a h" 'jmw-org-highlight-region)
#+END_SRC
* pkg
