...
org-mode. The following function adds a comment. The precise
implementation may change with my aesthetic preferences. 
#+BEGIN_SRC emacs-lisp
  (defun jmw-org-comment ()
    ...
    (insert " JMW:* "))
  (global-set-key (kbd "C-c o c") 'jmw-org-comment)
#+END_SRC
* pkg
